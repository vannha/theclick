        ...
        switch ($args['style']) {
            ...
            case '2':
                echo '<div class="'.trim(implode(' ', $paginate_links)).'">';
                    echo paginate_links([
                        'prev_text' => '<span class="prev">'.apply_filters('theclick_loop_pagination_prev_text', esc_html__('Previous', 'theclick')).'</span>',
                        'next_text' => '<span class="next">'.apply_filters('theclick_loop_pagination_next_text', esc_html__('Next', 'theclick')).'</span>'
                    ]); 
                echo '</div>';
                break;
            case '1':
