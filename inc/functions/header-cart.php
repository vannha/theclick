...
if(!function_exists('theclick_header_cart')){
	...
	?>
		<a href="#ef5-cart-popup" class="<?php echo implode(' ', $cart_classes);?>"><span class="icon <?php echo esc_attr($args['icon']);?>"><span class="header-count cart_total style-<?php echo esc_attr($args['style']);?>"><?php theclick_woocommerce_cart_counter(['style' => $args['style']]); ?></span></span></a>
	<?php
