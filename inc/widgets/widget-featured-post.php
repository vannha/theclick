    ...
    function widget( $args, $instance )
    {
        ...
        if ( $r->have_posts() )
        {
            ...
            while ( $r->have_posts() )
            {
                ...
                printf('<div class="fea-item"><div class="ef5-posted-in">%1$s</div><a href="%2$s" class="fea-item-title">%3$s</a></div>',$terms,esc_url( get_permalink() ), esc_attr( get_the_title() )); 
                echo '</div>';
            } // while
