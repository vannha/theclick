    ...
    'fields' => array(
        ...
        array(
            ...
            'options'  => array(
                ...
                '4' => esc_html__('Layout 4', 'theclick'),
                '6' => esc_html__('Layout 6', 'theclick'),
                '7' => esc_html__('Layout 7', 'theclick'),
                '8' => esc_html__('Layout 8', 'theclick'),
                '9' => esc_html__('Layout 9', 'theclick'),
                '10' => esc_html__('Layout 10', 'theclick'),
                '11' => esc_html__('Layout 11', 'theclick'),
                '12' => esc_html__('Layout 12', 'theclick'),
                '13' => esc_html__('Layout 13', 'theclick'),
                '14' => esc_html__('Layout 14', 'theclick')
            ),
            'default'  => ''
        ),
        array(
