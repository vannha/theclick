    ...
    function theclick_header_opts($args = []){
        ...
        return array(
            ...
            array(
                ...
                'required' => array('header_layout' ,'not_contain', array('8','10'))
            ),
            array(
                'id'       => 'header_menu_left',
                'type'     => 'select',
        ...
        return array_merge(
            array(
                ...
                array(
                    ...
                    'default'  => $default_value,
                    'required' => array(
                        array('header_search', '=', '1'),array('header_layout', '=', array('1','2','3','4','5','6','7'))
                    )
                )
            ),
    ...
    function theclick_header_social_counter($options, $default_value){
        ...
        return array(
            array(
                ...
                'options'  => $options,
                'default'  => $default_value,
                'required' => array('header_layout', '=', array('13', '14'))
            )
        );
    }
}
...
if(!function_exists('theclick_page_title_opts')){
    function theclick_page_title_opts($args=[]){
        ...
        if($args['default']){
            ...
            $custom_ptitle_logo = $ptitle_align = '';
        }
        return array(
            array(
                'id'       => 'ptitle_layout',
