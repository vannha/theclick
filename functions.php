...
if(!function_exists('theclick_configs')){
    function theclick_configs($value){
        $configs = [
            ...
            'theclick_product_single_image_w' => theclick_get_theme_opt('product_single_image_size',['width' => '480'])['width'],
            'theclick_product_single_image_h' => theclick_get_theme_opt('product_single_image_size',['height' => '645'])['height'],
...
{  
    ...
    if(class_exists('Woocommerce')) {
        ...
        if( is_singular( 'product' ) && $product_style == 'sticky'){
...
function theclick_inline_styles() {
    ...
    /* Ontop Header Color */
    $ontop_header_text_color = theclick_get_opts('ontop_header_text_color',['color' => '', 'alpha' => '', 'rgba' => 'inherit']);
    printf(':root{
            --ontop_text_color: %1$s;
        }', 
        $ontop_header_text_color['rgba']
    );
