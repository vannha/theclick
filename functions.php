...
if(!function_exists('theclick_configs')){
    function theclick_configs($value){
        $configs = [
            ...
            'theclick_product_gallery_thumbnail_w' => theclick_get_theme_opt('product_gallery_thumbnail_size',['width' => '118'])['width'],
            'theclick_product_gallery_thumbnail_h' => theclick_get_theme_opt('product_gallery_thumbnail_size',['height' => '148'])['height'],
