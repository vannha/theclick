(function( $ ) {
    ...
    $( document ).ready( function() {
        ...
        theclick_product_single_gallery_slider()

        // cart page
        theclick_remove_cart_actions();
        theclick_table_cart_content();
        theclick_table_move_column('.woocommerce-cart-form__contents', '.woocommerce-cart-form__cart-item' ,0, 5, '', '.product-subtotal', '');
        // End WooCommerce
        theclick_svg_color();
    ...
    */
    ...
    function theclick_table_cart_content(){
        "use strict";
    ...
    function theclick_product_single_variations_att(){
        ...
        $(document).on('click','.product-style-sticky .product_refill-image',function () { 
            var $this = $(this);
            var new_src = $this.attr('data-image');
            var new_src_full = $this.attr('data-img-full');
            
            if(new_src){
                var image = $('.product-style-sticky .p-thumb.thumbnail-slider-item img');
        ...
        $(document).on('click','.product-style-slider .product_refill-image',function () { 
            var $this = $(this);
            var new_src = $this.attr('data-image');
            var new_src_full = $this.attr('data-img-full');
            
            if(new_src){
                var image = $('.product-style-slider .thumbnail-slider-item.slick-current img');
        ...
        $('.reset_variations').on('click', function (e) {
            ...
            if( $('.product-style-sticky .thumbnail-slider-item').length > 0 ){
               var $current_img = $(document).find('.product-style-sticky .p-thumb.thumbnail-slider-item img');
    ...
    function theclick_product_single_gallery_slider(){
        $('.product-style-slider .main-img-slider').slick({
            vertical: false,
            slidesToShow: 3,
            focusOnSelect: true,
            centerPadding: "40px",
    ...
    function theclick_ajax_loadmore(){
        'use strict';
