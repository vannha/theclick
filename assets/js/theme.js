    ...
    function theclick_catalog_mega_menu(){
        ...
        if($('.ef5-catalog-menu').length){
            ...
            $('.cat-item-parent.has-child').on('click', function(e){ 
                ...
                $(this).parents('.ef5-catalog-menu').find('.catalog-child-wrap > :not(.'+data_parent+')').fadeTo('0.1',0).css('display','none');
                $(this).parents('.ef5-catalog-menu').find('.catalog-img-wrap > :not(.'+data_parent+')').fadeTo('0.1',0).css('display','none');
                $(this).parents('.ef5-catalog-menu').find('.catalog-child-wrap .'+data_parent).fadeTo('0.3',1).css('display','block');
                $(this).parents('.ef5-catalog-menu').find('.catalog-img-wrap .'+data_parent).fadeTo('0.3',1).css('display','block');
            }); 
        } 
    }
	/**
