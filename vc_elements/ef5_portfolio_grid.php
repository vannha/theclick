...
vc_map(array(
		'name' => 'TheClick Portfolio Grid',
	    'base' => 'ef5_portfolio_grid',
	    ...
	    "params" => array_merge(
	        array(
	        	array(
	                ...
	                'value'      =>  array(
	                    '1'          => get_template_directory_uri().'/vc_elements/layouts/portfolio-layout1.jpg',
	                ),
	                'std'        => '1',
	            ),
	            ...
	            array(
					...
					'settings' => array(
						...
						'delay'          => 500,
						'auto_focus'     => true,
						'values'   =>  theclick_get_portfolio_categories_for_autocomplete(),
					),
...
class WPBakeryShortCode_ef5_portfolio_grid extends WPBakeryShortCode{
	...
	protected function theclick_portfolios_wrap_css_class($atts){
        extract($atts);

        $css_classes = array(
            'ef5-portfolio-grid-'.$layout_template,
    ...
    protected function loadmore($atts = ''){
        ...
        echo '<div class="grid-loadmore-btn d-flex justify-content-center text-center">';
