        ...
        array(
            ...
            array(
                ...
                'value' =>  array(
                    ...
                    '4'  => get_template_directory_uri().'/vc_elements/layouts/post-4.jpg',
                ),
                'std'   => '1',
...
class WPBakeryShortCode_ef5_posts extends WPBakeryShortCode{
    ...
    protected function theclick_posts_featured_item_two($atts, $args = []){
        $args = wp_parse_args($args, [
            'class' => ''
        ]);
        $css_class = ['ef5-post-item-featured', $args['class']];
        ...
        <div class="<?php echo trim(implode(' ', $css_class));?>">
            ...
            <div class="content-bottom">
                ...
                printf('<div class="ef5-readmore text-center"><a href="%1$s" title="%2$s" class="readmore-link">%3$s</a></div>',
    ...
    protected function theclick_posts_item($atts, $args = []){
        ...
        <div class="ef5-list ef5-post-item <?php echo esc_attr($args['class']);?>">
            ...
            <div class="ef5-loop-info"><?php
                ...
                theclick_post_title();
                theclick_post_excerpt(['show_excerpt' => '1', 'length' => '38' ]);
