...
<div id="<?php echo esc_attr($el_id); ?>" class="<?php $this->theclick_banner_wrap_css_class($atts); ?>">
    ...
    switch ($banner_style) {
        ...
        case '4': 
            ...
            $this->theclick_banner_main_media($atts,['class' => 'col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-auto']);
            echo '<div class="content-wrap col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-auto">'; 
            $this->theclick_banner_sub_title($atts,['class' => '']);
            $this->theclick_banner_main_title($atts,['class' => '']);
